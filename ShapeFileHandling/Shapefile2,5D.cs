...
namespace Assets.PipelineGenerator.Scripts.ESRI.ShapeImporter25D
{
    /// <summary>
...
#pragma warning restore IDE0044 // Add readonly modifier
        ...
        /// <summary>
        /// Whethere or not the file has finished being read.
        /// </summary>
        public bool ReadFile { get; set; } = false;
        #endregion Properties
...
#pragma warning restore IDE0011 // Add braces
            ...
            Task newTask = new Task(()=> {
                this.ReadShapes(fileName + ".shp");
                ReadFile = true;
                Debug.Log("Finished Reading Shape Information");
            });
            newTask.Start();
        }
        ...
        public void ReadShapes2(string fileName)
        {
            using (FileStream stream = new FileStream(fileName, FileMode.Open, FileAccess.Read))
            {
                Stream = stream;
                this.ReadShapes2(stream);
            }
        }
        public void ReadShapes2(Stream stream)
        {
