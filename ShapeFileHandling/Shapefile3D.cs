...
namespace Assets.PipelineGenerator.Scripts.ESRI.ShapeImporter3D
{
    /// <summary>
...
#pragma warning restore IDE0032 // Use auto property
        ...
        public override string ToString()
        {
            ...
            sb.AppendFormat(
                "ShapeFileHeader: FileCode={0}, FileLength={1}, Version={2}, ShapeType={3}, xMin={4}, xMax={5}, yMin={6}, yMax={7}, zMin={8}",
                this.fileCode, this.fileLength, this.version, this.shapeType, this.xMin, this.xMax, this.yMin,
                this.yMax, this.zMin);
...
#pragma warning disable IDE0032 // Use auto property
#pragma warning disable IDE0044 // Add readonly modifier
        private Collection<Vector3> points = new Collection<Vector3>();
#pragma warning restore IDE0044 // Add readonly modifier
#pragma warning restore IDE0032 // Use auto property
        ...
        public void ReadShapeFileHeader(Stream stream)
        {
            ...
            if (this.fileHeader.FileCode != ShapeFile.expectedFileCode)
            {
                string msg = String.Format(System.Globalization.CultureInfo.InvariantCulture,
                    "Invalid FileCode encountered. Expecting {0}.", ShapeFile.expectedFileCode);
            ...
            this.fileHeader.ZMin = ShapeFile.ReadDouble64_LE(stream);
            this.fileHeader.XMax = ShapeFile.ReadDouble64_LE(stream);
            this.fileHeader.YMax = ShapeFile.ReadDouble64_LE(stream);
            this.fileHeader.ZMax = ShapeFile.ReadDouble64_LE(stream);
            ...
            if (Math.Abs(this.fileHeader.ZMax - this.fileHeader.ZMin) < 1)
            {
                this.fileHeader.ZMin -= 5;
                this.fileHeader.ZMax += 5;
            }
...
#pragma warning restore IDE0017 // Simplify object initialization
            ...
            switch (record.ShapeType)
            {
                ...
                {
                    string msg = String.Format(System.Globalization.CultureInfo.InvariantCulture,
                        "ShapeType {0} is not supported.", (int) record.ShapeType);
                    throw new ArgumentException(msg);
                }
            }
